 ...
 player_t::player_t() noexcept
    : body(physics::create_body(game_id_e::Player,
      ...
      shape(physics::create_box_shape(
          body, {
                    .collision_type =
                        (cpCollisionType)physics::collision_type_e::Player,
                    .bounding = lib::rect_t({0, 0}, {bounding_box_size}),
                    .radius = 1,
                }))
{
    // add a collision handler to keep track of when player is colliding with a
    // static body
...
void player_t::collision_handler_static(cpArbiter *arb, cpSpace *space,
                                        cpDataPointer userData)
{
    ...
    physics::raw_poly_shape_t shape_a =
        physics::get_handle_from_polygon_shape(*((lib::poly_shape_t *)arb->a));
    physics::raw_poly_shape_t shape_b =
        physics::get_handle_from_polygon_shape(*((lib::poly_shape_t *)arb->b));
